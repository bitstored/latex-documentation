...
\definecolor{celestialblue}{rgb}{0.19, 0.49, 0.72}
\definecolor{deepchampagne}{rgb}{0.88, 0.74, 0.55}
\definecolor{munsell}{rgb}{0.0, 0.56, 0.45}
...
\end{table}
%%% move cites of official documentation to footnote
...
% TODO : Descrie cazuri de utilizare
\section{Tehnologii}
...
\end{center}
\end{figure}
%%adauga legaturi la steganografie 
